class Cell {
	...
	constructor(givenPosition, givenRadius, givenCellColor) {
		...
		this.radius = givenRadius || 25;
		this.cellColor = givenCellColor || color(random(100, 255), 0, random(100, 255));
	}
	...
	clicked(givenX, givenY) {
		let distance = dist(this.position.x, this.position.y, givenX, givenY);
	...
	mitosis(){
		...
		let cell = new Cell(this.position, this.radius * 0.8, this.cellColor);
		return cell;
	}
}
